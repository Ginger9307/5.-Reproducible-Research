...
The mean (blue line) of steps taken per day is about `r round(mean.steps)`.

The median (red line) of steps taken per day is about `r median.steps`.
...
5-minute interval, on average across all the days in the dataset, containing the maximum number of steps (`r round(max.steps)` steps), is `r max.act.interval`. 
...
The mean (blue line) of steps taken per day after filling missing data is about `r round(f.mean.steps)`.

The median (red line) of steps taken per day after filling missing data is about `r f.median.steps`. 
